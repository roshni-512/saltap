...
export default function Fearurecomponent3() {
  return (
  ...
  <div className=' my-4' style={{ fontFamily: "Fraunces" }} >
      ...
      <div className='col-xl-5 col-sm-5 col-md-12 mt-5 mb-5 col-lg-5 '>
              <img src={"./images/feature11.png"} style={{ width: '100%', float: 'right' }}  alt='' />
          </div>
      <div className='col-xl-5 col-sm-5 col-md-12 mt-5 mb-5 col-lg-5 ps-sm-5' style={{display:'fllex', alignSelf:'center'}}>
      <p style={{fontFamily:'Alfa Slab One',fontSize:'84px',lineHeight:'93.545px' }} className='mt-5 mb-5'>Reliable</p>
